 ...
 *
 */
public class NZBottomNavigationFABBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {

	private int navigationBarHeight = 0;
	private long lastSnackbarUpdate = 0;

	public NZBottomNavigationFABBehavior(int navigationBarHeight) {
	...
	public boolean layoutDependsOn(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
		if (dependency != null && dependency instanceof Snackbar.SnackbarLayout) {
			return true;
		} else if (dependency != null && dependency instanceof NZBottomNavigation) {
			return true;
		}
	...
	private void updateFloatingActionButton(FloatingActionButton child, View dependency) {
		...
		} else if (child != null && dependency != null && dependency instanceof NZBottomNavigation) {
