...
import com.nozbottomnavigation.menu.NZBottomNavigation.OnNavigationPositionListener;

/**
 *
 */
public class NZBottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	 ...
	 * Constructor
	 */
	public NZBottomNavigationBehavior() {
		super();
	}

	public NZBottomNavigationBehavior(boolean behaviorTranslationEnabled, int navigationBarHeight) {
		super();
		this.behaviorTranslationEnabled = behaviorTranslationEnabled;
		this.navigationBarHeight = navigationBarHeight;
	}

	public NZBottomNavigationBehavior(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NZBottomNavigationBehavior_Params);
		mTabLayoutId = a.getResourceId(R.styleable.NZBottomNavigationBehavior_Params_tabLayoutId, View.NO_ID);
		a.recycle();
	}
	...
	public static <V extends View> NZBottomNavigationBehavior<V> from(V view) {
		...
		CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
				.getBehavior();
		if (!(behavior instanceof NZBottomNavigationBehavior)) {
			throw new IllegalArgumentException(
					"The view is not associated with AHBottomNavigationBehavior");
		}
		return (NZBottomNavigationBehavior<V>) behavior;
	}
