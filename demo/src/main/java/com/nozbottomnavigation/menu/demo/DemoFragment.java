...
//				demoActivity.updateSelectedBackgroundVisibility(isChecked);
		...
		for (NZBottomNavigation.TitleState titleState : NZBottomNavigation.TitleState.values()) {
		...
		spinnerTitleState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				NZBottomNavigation.TitleState titleState = NZBottomNavigation.TitleState.valueOf(titleStates.get(position));
